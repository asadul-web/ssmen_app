...
public class PayloadDialog implements SettingsConstants{
    ...
    private Spinner pLogo,proto_spin,payload_v2ray_type_spinner;
        ...
        proto_spin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    v.findViewById(R.id.payload_v2ray_type_ly).setVisibility(View.GONE);
                }else if (position==1){
                    ...
                    ((TextInputLayout) v.findViewById(R.id.etNetworkPayloadInput)).setHint("V2Ray SNI Host");
                    v.findViewById(R.id.etNetworkPayloadInput).setVisibility(View.VISIBLE);
                    v.findViewById(R.id.excluded_udp_layout).setVisibility(View.GONE);
                    v.findViewById(R.id.radio_type).setVisibility(View.GONE);
                    v.findViewById(R.id.payload_v2ray_type_ly).setVisibility(View.VISIBLE);
                    btnPayloadGen.setVisibility(View.GONE);
                }
            }
            @Override
    ...
    public void edit(JSONObject json) {
        ...
        try {
            ...
            int protoSpinValue = json.getInt("proto_spin");

            if (protoSpinValue == 6) {
                proto_spin.setSelection(3);
            } else {
                proto_spin.setSelection(protoSpinValue);
            }
//            proto_spin.setSelection(json.getInt("proto_spin"));
            payload_v2ray_type_spinner.setSelection(json.getInt("V2rayPayloadType"));
            etNetworkName.setText(json.getString("Name"));
            etNetworkPayload.setText(c_01.decrypt(json.getString("NetworkPayload")));
            ...
            etNetworkFrontQuery.setText(c_01.decrypt(json.getString("NetworkFrontQuery")));
            etNetworkBackQuery.setText(c_01.decrypt(json.getString("NetworkBackQuery")));
    ...
    public void onPayloadAdd(final SpinnerListener oca) {
        ...
        v.findViewById(R.id.save).setOnClickListener(p1 -> {
            ...
            try {
                ...
                if (proto_spin.getSelectedItem().toString().equals("V2ray/Xray")) {
                    protoSpin = 6;
                }
                ...
                jo.put("NetworkPayload", c_01.encrypt(etNetworkPayload.getText().toString()));
                ...
                jo.put("V2rayPayloadType", payload_v2ray_type_spinner.getSelectedItemPosition());
                jo.put("NetworkFrontQuery", c_01.encrypt(etNetworkFrontQuery.getText().toString()));
                jo.put("NetworkBackQuery", c_01.encrypt(etNetworkBackQuery.getText().toString()));
