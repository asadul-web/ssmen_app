...
package mtkdex.core.build.ssmen.core;
...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public String getConfigFile(Context context, boolean configForOvpn3) {
        ...
        SharedPreferences prefs = MainApplication.getDefaultSharedPreferences();
...
//        }
   ...
   /* public void writeConfigFile(Context context) throws IOException {
    ...
    /*public Intent getStartServiceIntent(Context context) {
        ...
        Intent intent = new Intent(context, dex003.class);
    ...
    public void checkForRestart(final Context context) {
        /* This method is called when dex003 is restarted */
