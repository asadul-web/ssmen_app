...
import mtkdex.core.build.ssmen.core.CIDRIP;
import mtkdex.core.build.ssmen.core.NetworkSpace;
import mtkdex.core.build.ssmen.core.vpnutils.Pdnsd;
import mtkdex.core.build.ssmen.core.vpnutils.Tun2Socks;
...
@Obfuscate
public class dex004 extends VpnService implements SettingsConstants {
    public static final String START_VPN_SERVICE = "mtkdex.core.build.org.service.START_VPN_SERVICE";
    public static final String STOP_VPN_SERVICE = "mtkdex.core.build.org.service.STOP_VPN_SERVICE";
    ...
    public IBinder onBind(Intent intent) {
        ...
        if (intent == null) return super.onBind(intent);
    ...
    public void onCreate() {
        ...
        mConfig = ConfigUtil.getInstance(dex004.this);
    ...
    private void destroyAll(){
        ...
        submit_destroy_builder();
        if(hLogStatus.isTunnelActive())startService(new Intent(dex004.this, dex002.class).setAction(dex002.STOP_SERVICE).putExtra("stateSTOP_SERVICE", getResources().getString(R.string.state_disconnected)));
    }
    ...
    private String[] mDnsResolvers(){
        ...
        if (forwardDns)
            ...
            List<String> lista = VpnUtils.getNetworkDnsServer(dex004.this);
    ...
    private void startVpn(boolean forwardDns, String[] dnsResolver, String excludeIps, boolean enabledFilter, boolean filterBypassMode, Set<String> filterApps, boolean enableTethering, boolean isSlowDNS) throws Exception {
        ...
        try {
            ...
            tunFd = builder
                    ...
                    .setConfigureIntent(ConfigUtil.getPendingIntent(dex004.this))
                    .establish();
    ...
    private boolean routeThroughTunnel(final String socksServerAddress, final String[] dnsResolver, boolean forwardDns, final String udpResolver, final boolean transparentDns){
        ...
        if (forwardDns) {
            ...
            mPdnsd = new Pdnsd(dex004.this, dnsResolver, DNS_RESOLVER_PORT, mPrivateAddress.mIpAddress, pdnsdPort);
            mPdnsd.start();
        }
        mTun2Socks = new Tun2Socks(dex004.this, tunFd, mMtu, mPrivateAddress.mRouter, VPN_INTERFACE_NETMASK, socksServerAddress, udpResolver, dnsgwRelay, transparentDns);
        mTun2Socks.start();
        return true;
    }
