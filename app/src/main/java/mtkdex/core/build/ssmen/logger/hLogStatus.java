...
public class hLogStatus
{
    ...
    private static void logInformation() {
        ...
        ConfigUtil.getInstance(MainApplication.getApp()).networkStateChange(true);
    }
    ...
    public static void addByteCountListener(ByteCountListener bcl) {
        if (byteCountListener.contains(bcl)) return;
    ...
    public static int getProgressState(String state) {
        return switch (state) {
            case VPN_CONNECTING -> 40;
            case VPN_WAITING -> 20;
            case VPN_NO_NETWORK -> 30;
            case VPN_AUTHENTICATING -> 85;
            case VPN_GET_CONFIG -> 70;
            case VPN_ASSIGN_IP -> 75;
            case VPN_ADD_ROUTES -> 80;
            case VPN_CONNECTED -> 100;
            case VPN_DISCONNECTED -> 1;
            case VPN_RECONNECTING -> 50;
            case VPN_STARTING -> 10;
            case VPN_STOPPING -> 1;
            case VPN_RESOLVE -> 60;
            case VPN_PAUSE -> 65;
            case VPN_RESUME -> 80;
            case VPN_AUTH_PENDING -> 70;
            case VPN_AUTH_FAILED -> 1;
            default -> 1;
        };
    }
    /**
