...
{
    String[] mTypeList = {"OpenVPN (Stable)", "Hysteria (Udp)", "Secure Shell (SSH)", "Slowdns (Dnstt)", "V2Ray/Xray (Core)"};
    String[] sPort = {"Default","2086","2096","1194","992","110","446","444","443","442","80","53","22"};
    String[] pPort = {"Default","80","8080","8081","8789","8799","8000","8888","3128","6969","6868","446","444","443","442","2222","550"};
    String UDP_CLI = "{\n  \"server\": \"%s\",\n  \"obfs\": \"%s\",\n  \"auth_str\": \"%s\",\n  \"up_mbps\": %s,\n  \"down_mbps\": %s,\n  \"retry\": %s,\n  \"retry_interval\": %s,\n  \"socks5\": {\n    \"listen\": \"%s\"\n  },\n  \"http\": {\n    \"listen\": \"%s\"\n  },\n  \"insecure\": %s,\n  \"lazy_start\": true,\n  \"ca\": \"%s\",\n  \"recv_window_conn\": %s,\n \"recv_window\": %s\n}";
    ...
    String
            ...
            v2ray_server_type_mSelection_key = "v2ay_server_type_mSelection_key",
            v2ray_payload_type_mSelection_key = "v2ay_payload_type_mSelection_key",
    ...
    CONFIG_EXP_KEY = "_CONFIG_EXP_KEY",
            ...
            CUSTOM_SERVER_POR_KEY = "_CUSTOM_SERVER_POR_KEY",
            CUSTOM_NETWORK_PORT_KEY = "_CUSTOM_NETWORK_PORT_KEY",
            ...
            LOAD_OVPN_SSH_TWEAKS_KEY = "_LOAD_OVPN_SSH_TWEAKS_KEY",
    ...
    // Stringer
       String
            ...
            SERVER_TYPE_CDN_V2RAY = "V2RAY-CDN-Tunnel:",
            SERVER_TYPE_SSL_V2RAY = "V2RAY-SSL-Tunnel:",
